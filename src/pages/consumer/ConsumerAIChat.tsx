  ...
  const [messages, setMessages] = useState<AIMessage[]>([
    {
      id: 'init-msg',
      role: 'assistant',
      content: 'Namaskara! I am your **Farmlynq Consumer Assistant**. I can help you find fresh produce directly from verified farmers, compare mandi prices, or track your orders. What produce are you looking for today?',
